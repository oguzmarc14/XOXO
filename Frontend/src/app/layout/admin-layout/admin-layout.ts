...
export class AdminLayout
  ...
  private actualizarEncabezado(): void {
    ...
    if (
      ...
      this.subtitulo =
        'Consulta y administra las sucursales registradas';
    ...
    if (
      ...
      this.subtitulo =
        'Consulta indicadores y resultados del sistema';
    ...
    if (
      url.includes('/historial-ventas')
    ) {
      this.titulo =
        'Historial de ventas';

      this.subtitulo =
        'Consulta todas las operaciones registradas';
    ...
    if (
      url.includes('/movimientos-inventario')
    ) {
      this.titulo =
